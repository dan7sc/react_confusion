...
const Favorites = (props) => {
    if (props.favorites.isLoading) {
        ...
        const favorites = props.favorites.favorites[0].dishes.map((favorite) => {
            return (
                <div key={favorite.id} className="col-12 mt-5">
                    <RenderMenuItem dish={favorite} deleteFavorite={props.deleteFavorite} />
                </div>
            );
        });
